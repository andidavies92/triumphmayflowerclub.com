import HomePageBodySection from "model/pages/home/HomePageBodySection";
...
const HomePageBodySections: HomePageBodySection[] = [
    ...
    {
        title: "News",
        body: "The latest goings-on from the club, including announcements, event details, etc. This will be the most up-to-date source of information for club members so be sure to check back regularly."
    },
    {
        title: "Events",
    ...
    {
        title: "Forum",
        body: "Coming soon! We hope to establish in future an online forum for members to discuss anything and everything to do with Mayflowers and the club. Visit this section to read more about this as well as examples of the kinds of systems we might use for it."
    },
    {
        title: "Contact",
        body: "Need to get in touch with the committee or other members of the club? Visit this section to view a list of up-to-date contact details for individuals involved with our club. Please also let us know if you notice any incorect or out-of-date details!"
    },
    {
        title: "Links",
    ...
    {
        title: "Search",
        body: "This will be the next major addition to the website after launch. Given that this new website contains a large amount of Mayflower-related material, it makes sense that it should be possible to search this veritable goldmine of information to more easily find and discover articles and titbits."
    }
];

export default HomePageBodySections;
